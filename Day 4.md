...
- let: The let declaration declares re-assignable, block-scoped local variables.
- var: The var statement declares function-scoped or globally-scoped variables.
